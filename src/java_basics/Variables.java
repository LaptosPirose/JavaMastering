...
public class Variables {
	...
	public static void main(String[] args) {
		...
		/*
		 * First variable type and the car name. You don't need to declare a first
		 * value.
		...
		/*
		 * You can not put letters on the beginning of a variable declaration but you
		 * can put in the end.
		 * Like this:
		 */
		...
		/*
		 * But not like this:
		 * 123words or maybe using special characters like 12@sd. About the special
		 * chars not only in beginning
		...
		/*
		 * As we wait from variables that contain numbers, all math operations can be
		 * solved using this variables
		...
		/*
		 * But as you can see, y still remaining the data 50, because none of results
		 * were storage in some
		 * other variables.
		 */

		/*
		 * Strings can also perform a + operation but that means concatenation, that add
		 * some string in the end
		 * of other. Let's see.
		 */
