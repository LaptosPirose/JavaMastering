...
public class LogicalOperators {
    public static void main(String[] args) {
        ...
        if (hasDrivingLicense && hasInsurance) {
            ...
            System.out.println("You cannotlegally drive.");
        ...
        if (!isVowel) {
            System.out.println(String.format("The letter %c is a consonant.", letter));
        } else {
            System.out.println(String.format("The letter %c is a vowel.", letter));
        }
